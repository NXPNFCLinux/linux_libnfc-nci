...
//#define DLOG_IF(INFO, nfc_debug_enabled) cout<<endl
//#define CHECK(free_buf) cout<<endl
//#define LOG(ERROR) cout <<endl
using namespace std;
//#define StringPrintf DBG_PRINT 
//#define ALOGE(...) { printf("\n");printf(__VA_ARGS__);printf("\n"); }
//#define NXPLOG_API_D(...) {printf("\n");printf(__VA_ARGS__);printf("\n");}
//#define NXPLOG_API_W(...) {printf("\n"); printf(__VA_ARGS__);printf("\n"); }
//void
//android_errorWriteLog(int errnum, const char *fmt);
#if 0 
class DBG_PRINT {
    private:
    ...
    public:
        ...
        friend ostream &operator<<( ostream &output, const DBG_PRINT &D ) { 
            return output;            
        }
};
#endif   
