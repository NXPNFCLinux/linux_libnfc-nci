...
/**file required in other files like src/adaptation/CrcChecksum.cc**/
#ifdef ANDROID
#	include <io.h>
#endif
#	include <sys/types.h>
...
// Appends a printf-like formatting of the arguments to 'dst'.
	...
	/***************************************************************
	** commenting __attribute__ GNU KEYWORD should not be problem **
	** Refer: http://www.delorie.com/gnu/docs/gcc/gcc_55.html     **
	** We mannualy need to care that all above functions takes    **
	** printf() like arguments based on the respective number     **                 
	****************************************************************/
#undef ANDROID_BASE_FORMAT_ARCHETYPE
}  // namespace base
}  // namespace android
