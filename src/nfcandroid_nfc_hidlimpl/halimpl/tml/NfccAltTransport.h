...
// Default GPIO pin values (system GPIO numbers for Raspberry Pi CM4)
// These are fallback values - actual pins are read from libnfc-nxp.conf
#define PIN_INT 535      // GPIO23 -> system GPIO 535 (default)
#define PIN_ENABLE 536   // GPIO24 -> system GPIO 536 (default)
#define PIN_FWDNLD 537   // GPIO25 -> system GPIO 537 (default)
#define EDGE_NONE 0
